...
export default function BottomTabBar() {
  return (
    <div className="fixed bottom-0 left-1/2 -translate-x-1/2 w-full max-w-md glass border-t border-[#EAE6E1] h-20 pb-4 flex justify-around items-center px-2 z-40">
